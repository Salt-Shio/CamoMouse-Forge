 ...
 *             : WCH Version            : V1.0.0 Date               : 2022/08/18
...
/* File Version */
#define DEF_FILE_VERSION 0x90

/* USB Device Info */
#define DEF_USB_VID 0x046d
#define DEF_USB_PID 0xc07e
...
#define DEF_USBD_QUALFY_DESC_LEN ((uint16_t)MyQuaDesc[0]) // no use
