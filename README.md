...
1. 進到 `Firmware`
2. 執行 `D:\MounRiver\MounRiver_Studio2\resources\app\resources\win32\others\Build_Tools\Make\bin\make.exe TOOLCHAIN_PATH="D:/MounRiver/MounRiver_Studio2/resources/app/resources/win32/components/WCH/Toolchain/RISC-V Embedded GCC/bin"`
...
* usbd_composite_km.c
    ...
    * 重點在於:
        ...
        * KM_Data_Pack 是 8 bytes，但是 G402 實際是 18 bytes 來控制
